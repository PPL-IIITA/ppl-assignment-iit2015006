...
/**
 *this is main class of the solution program , it inputs data from the csv file and stores them in the reapective array and computes result
 * @author Aditya
 */
import Boys.*;
...
public class main_class_q3 {
	...
	static int total_Utility_gifts=0;
         /**
         * the main function 
         * @param args argument of the args
         * @throws IOException 
         */
	...
	public static int couple_matching(boy []man , girl []women,couples_info couples[]) throws IOException{
		/*
            this is used to match couples and form couples according to each individuals need
            */
	...
	static void k_most_compactible_and_happy(couples_info couple[],int k) throws IOException{
            /*
            it calculates the  kt most compactible couples 
            */
