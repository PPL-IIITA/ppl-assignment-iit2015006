...
public class couples_info {
	...
	public couples_info(String b_name , int b_happiness , int b_budget , int b_attract , int b_intell,String g_name , int g_happiness , int g_budget , int g_attract , int g_intell){
